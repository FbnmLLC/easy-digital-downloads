...
{
    $gateways['_123pay'] = array('admin_label' => 'سامانه پرداخت اینترنتی یک دو سه پی', 'checkout_label' => 'پرداخت با یک دو سه پی');
    return $gateways;
}
...
function process_payment($purchase_data)
{
    ...
    if ($payment) {
        ...
        $callback_url = add_query_arg('order', '_123pay', get_permalink($edd_options['success_page']));
